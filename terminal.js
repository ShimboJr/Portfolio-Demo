...
(function () {
  ...
  const STUB_PROJECTS = [
    ...
    },
    {
      ...
      description: 'Real-time banking analytics with D3.js charts and WebSocket price feeds.',
      tech: ['React', 'TypeScript', 'D3.js', 'Node.js', 'PostgreSQL'],
      github: 'https://github.com/shimbojr/fintech-dash',
      live: 'https://dash.shimbojr.dev',
      image: '',
      dateAdded: '2024-09-10T00:00:00Z',
    },
    {
      id: 'stub-scaffold-cli',
      title: 'CLI Scaffold Tool',
      description: 'Opinionated project scaffolding CLI for React/Next.js monorepos.',
      tech: ['Node.js', 'Python', 'Bash'],
      github: 'https://github.com/shimbojr/scaffold-cli',
      live: '',
      image: '',
